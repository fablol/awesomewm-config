...
local OPEN_WEATHER_URL = ("https://api.openweathermap.org/data/2.5/weather?lat=31.377756&lon=121.2606119&units=metric&appid=9e00ba899551d23d2c892c0bee324bfc")
...
local function update_widget(widget, stdout, stderr)
    ...
    temperature.markup = "<span foreground='" .. beautiful.fg_normal .. "'>" .. tostring(result.main.temp) ..
        " °C</span>"
    description.markup = "<span foreground='" .. beautiful.fg_normal .. "'>" .. result.weather[1].description ..
        "</span>"
